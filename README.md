...
| `@airprompter/otel-bridge` | 0.1.0 | 0.2.5 | `otel-mapping.json` | green |
| `@airprompter/agent-sdk` | 0.1.0 | 0.2.5 | `examples/heartbeat.*.json`, `examples/edge-pointer.json` | green |

Generated by `sdk-typescript/scripts/compat-table.mjs` from the conformance run on protocol `0.2.5` (Node 24). One version across the six packages; `@airprompter/agent-sdk` exact-pins its siblings; `@airprompter/otel-bridge` is optional and pins core.
<!-- compat-table:end -->
