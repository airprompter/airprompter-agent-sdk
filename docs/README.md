...
| [variables.md](variables.md) | Variables filled from your own system at render time: sources, precedence, trust (the stricter wins), `renderAsync`, `needs()`, workflows and managed mode | 0.2.10 |
