...
const manifestCases = [
  ...
  { name: "experiments[] with one split per slot verifies (S16)", ...base, root: rootV1, manifest: manifest(payload({ experiments: [experimentFor("support.triage", "exp_a"), experimentFor("support.reply", "exp_b")] })), expected: { ok: true } },
